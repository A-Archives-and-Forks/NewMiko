package im.mingxi.miko.util.xpcompat;
...
public class XPHelpers {
    ...
    private static final ConcurrentHashMap<MemberCacheKey.Method, Optional<Method>> methodCache =
            new ConcurrentHashMap<>();
    private static final ConcurrentHashMap<MemberCacheKey.Constructor, Optional<Constructor<?>>>
    ...
    public static void hookAllConstructorsBefore(Class<?> clz, XPBridge.HookCallback callBack) {
        for (Constructor con : clz.getDeclaredConstructors()) {
            XPBridge.hookBefore(con, callBack);
        }
    }

    public static void hookAllConstructorsAfter(Class<?> clz, XPBridge.HookCallback callBack) {
        for (Constructor con : clz.getDeclaredConstructors()) {
            XPBridge.hookAfter(con, callBack);
        }
    }
    ...
    public static Class<?> getClass(String className) {
        try {
            return Reflex.loadClass(className);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    /**
     * Look up and return a class if it exists. Like {@link #findClass}, but doesn't throw an
     * exception if the class doesn't exist.
     *
    ...
    /**
     * Look up and return a field if it exists. Like {@link #findField}, but doesn't throw an
    ...
    /**
     * Returns the first field of the given type in a class. Might be useful for Proguard'ed classes
     * to identify fields with unique types.
     *
     * @param clazz The class which either declares or inherits the field.
    ...
    /**
     * Look up a method and hook it. See {@link #findAndHookMethod(String, ClassLoader, String,
     * Object...)} for details.
     */
    public static void findAndHookMethodBefore(
        ...
        if (parameterTypesAndCallback.length == 0
                ...
                instanceof XPBridge.HookCallback))
            throw new IllegalArgumentException("no callback defined");

        XPBridge.HookCallback callback =
                (XPBridge.HookCallback)
                        parameterTypesAndCallback[parameterTypesAndCallback.length - 1];
        Method m =
                findMethodExact(
                        clazz,
        ...
        XPBridge.hookBefore(m, callback);
    }

    public static void findAndHookMethodAfter(
            Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        if (parameterTypesAndCallback.length == 0
                || !(parameterTypesAndCallback[parameterTypesAndCallback.length - 1]
                instanceof XPBridge.HookCallback))
        ...
        XPBridge.hookAfter(m, callback);
    }

    /**
     * Look up a method and hook it. The last argument must be the callback for the hook.
     *
     * <p>This combines calls to {@link #findMethodExact(Class, String, Object...)} and {@link
     * XposedBridge#hookMethod}.
     *
     * <p class="warning">The method must be declared or overridden in the given class, inherited
     * methods are not considered! That's because each method implementation exists only once in the
     * memory, and when classes inherit it, they just get another reference to the implementation.
     ...
     * shouldn't have to worry about hooks applying to superclasses, hence this "limitation". There
     * could be undesired or even dangerous hooks otherwise, e.g. if you hook {@code
     * SomeClass.equals()} and that class doesn't override the {@code equals()} on some ROMs, making
     * you hook {@code Object.equals()} instead.
     *
     ...
     * {@code String.class}. If you don't have the class reference, you can simply use the full
     * class name as a string, e.g. {@code java.lang.String} or {@code com.example.MyClass}. It will
     * be passed to {@link #findClass} with the same class loader that is used for the target
     * method, see its documentation for the allowed notations.
     *
     * <p>Primitive types, such as {@code int}, can be specified using {@code int.class}
     * (recommended) or {@code Integer.TYPE}. Note that {@code Integer.class} doesn't refer to
     * {@code int} but to {@code Integer}, which is a normal class (boxed primitive). Therefore it
     * must not be used when the method expects an {@code int} parameter - it has to be used for
     * {@code Integer} parameters though, so check the method signature in detail.
     *
     * <p>As last argument to this method (after the list of target method parameters), you need to
     * specify the callback that should be executed when the method is invoked. It's usually an
     * anonymous subclass of {@link XPBridge.HookCallback} or {@link XC_MethodReplacement}.
     *
     * <p><b>Example</b>
     *
     ...
     * findAndHookMethod("com.example.SomeClass", lpparam.classLoader, String.class, int.class, "com.example.MyClass", new XPBridge.HookCallback() {
     *   &#64;Override
     ...
     * @throws ClassNotFoundError In case the target class or one of the parameter types couldn't be
     *                            resolved.
     */
    public static void findAndHookMethodBefore(
            String className,
    ...
    /**
     * Look up a method in a class and set it to accessible. See {@link #findMethodExact(String,
     * ClassLoader, String, Object...)} for details.
     */
    public static Method findMethodExact(
            Class<?> clazz, String methodName, Object... parameterTypes) {
        return findMethodExact(
                clazz, methodName, getParameterClasses(clazz.getClassLoader(), parameterTypes));
    }

    /**
     * Look up and return a method if it exists. See {@link #findMethodExactIfExists(String,
     * ClassLoader, String, Object...)} for details.
     */
    ...
    /**
     * Look up a method in a class and set it to accessible. The method must be declared or
     * overridden in the given class.
     *
    ...
    /**
     * Look up and return a method if it exists. Like {@link #findMethodExact(String, ClassLoader,
     * String, Object...)}, but doesn't throw an exception if the method doesn't exist.
     *
     * @param className      The name of the class which implements the method.
     * @param classLoader    The class loader for resolving the target and parameter classes.
     * @param methodName     The target method name.
    ...
    /**
     * Returns an array of all methods declared/overridden in a class with the specified parameter
     * types.
     *
     * <p>The return type is optional, it will not be compared if it is {@code null}. Use {@code
     * void.class} if you want to search for methods returning nothing.
     *
    ...
    public static Method[] findMethodsByExactParameters(
            Class<?> clazz, Class<?> returnType, Class<?>... parameterTypes) {
     ...
     *
     * <p>This does'nt only look for exact matches, but for the best match. All considered
     * candidates must be compatible with the given parameter types, i.e. the parameters must be
     * assignable to the method's formal parameters. Inherited methods are considered here.
     *
     ...
     */
    public static Method findMethodBestMatch(
            Class<?> clazz, String methodName, Class<?>... parameterTypes) {
                            ...
                            do {
                                for (Method method : clz.getDeclaredMethods()) {
                                    ...
                                    if (!considerPrivateMethods
                                            && Modifier.isPrivate(method.getModifiers())) continue;

                                    // Compare name and parameters
                                    if (method.getName().equals(k.name)
                                            && areAssignable(
                                            k.parameters, method.getParameterTypes())) {
                                        // Get accessible version of the method
                                        if (bestMatch == null
                                                || compareMethodFit(method, bestMatch, k.parameters)
                                                < 0) {
                                            bestMatch = method;
                                        }
                                    }
    ...
    // Custom method to check if parameters are assignable
    private static boolean areAssignable(Class<?>[] from, Class<?>[] to) {
    ...
    // Custom comparison method for method "fit" (you can adjust this logic as per your need)
    private static int compareMethodFit(Method method1, Method method2, Class<?>[] parameters) {
        Class<?>[] paramTypes1 = method1.getParameterTypes();
        Class<?>[] paramTypes2 = method2.getParameterTypes();

        // Example: prioritize fewer parameters (you can adapt this logic to your needs)
        int diff1 = paramTypes1.length - parameters.length;
        int diff2 = paramTypes2.length - parameters.length;
    ...
    /**
     * Retrieve classes from an array, where each element might either be a Class already, or a
     * String with the full class name.
     */
    private static Class<?>[] getParameterClasses(
        ...
        for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
            ...
            if (type instanceof XPBridge.HookCallback) continue;
    ...
    /**
     * Look up a constructor of a class and set it to accessible. See {@link
    ...
    public static Constructor<?> findConstructorExact(Class<?> clazz, Object... parameterTypes) {
        return findConstructorExact(
                clazz, getParameterClasses(clazz.getClassLoader(), parameterTypes));
    }

    /**
     * Look up and return a constructor if it exists. See {@link #findMethodExactIfExists(String,
     * ClassLoader, String, Object...)} for details.
     */
    public static Constructor<?> findConstructorExactIfExists(
            Class<?> clazz, Object... parameterTypes) {
        try {
    ...
    public static Constructor<?> findConstructorExact(
            String className, ClassLoader classLoader, Object... parameterTypes) {
        return findConstructorExact(
                findClass(className, classLoader),
                getParameterClasses(classLoader, parameterTypes));
    }
                        ...
                        k -> {
                            try {
                                Constructor<?> constructor =
                                        k.clazz.getDeclaredConstructor(k.parameters);
    ...
    /**
     * Look up a constructor and hook it. See {@link #findAndHookMethod(String, ClassLoader, String,
     * Object...)} for details.
     */
    public static void findAndHookConstructorBefore(
    ...
    public static void findAndHookConstructorAfter(
            Class<?> clazz, Object... parameterTypesAndCallback) {
        if (parameterTypesAndCallback.length == 0
                || !(parameterTypesAndCallback[parameterTypesAndCallback.length - 1]
                instanceof XPBridge.HookCallback))
    ...
    public static void findAndHookConstructorBefore(
        ...
        findAndHookConstructorBefore(findClass(className, classLoader), parameterTypesAndCallback);
    }

    public static void findAndHookConstructorAfter(
            String className, ClassLoader classLoader, Object... parameterTypesAndCallback) {
        findAndHookConstructorAfter(findClass(className, classLoader), parameterTypesAndCallback);
    }
     ...
     */
    public static Constructor<?> findConstructorBestMatch(
                ...
                .computeIfAbsent(
                        ...
                        k -> {
                            ...
                            for (Constructor<?> constructor : constructors) {
                                // Compare name and parameters using reflection
                                if (areAssignable(k.parameters, constructor.getParameterTypes())) {
                                    // Get the accessible version of the constructor
                                    if (bestMatch == null
                                            || compareConstructorFit(
                                            constructor, bestMatch, k.parameters)
                                            < 0) {
    ...
    // Custom comparison method for constructor "fit" (you may adjust this logic as per your need)
    private static int compareConstructorFit(
            Constructor<?> constructor1, Constructor<?> constructor2, Class<?>[] parameters) {
        Class<?>[] paramTypes1 = constructor1.getParameterTypes();
        Class<?>[] paramTypes2 = constructor2.getParameterTypes();
    ...
    /**
     * Returns the index of the parameter declared with the given type, ensuring that there is
     * exactly one such parameter.
     *
        ...
        for (int i = 0; i < classes.length; i++) {
            if (classes[i] == type) {
                if (idx == -1) {
                    ...
                    throw new NoSuchFieldError(
                            "More than one parameter of type " + type + " found in " + method);
                }
            }
        }
        if (idx != -1) {
    ...
    /**
     * Sets the value of an object field in the given object instance. A class reference is not
     * sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code boolean} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code byte} field in the given object instance. A class reference is not
     * sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code char} field in the given object instance. A class reference is not
     * sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code double} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code float} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of an {@code int} field in the given object instance. A class reference is not
     * sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code long} field in the given object instance. A class reference is not
     * sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a {@code short} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of an object field in the given object instance. A class reference is not
     * sufficient! See also {@link #findField}.
     */
    ...
    /**
     * For inner classes, returns the surrounding instance, i.e. the {@code this} reference of the
     * surrounding class.
     */
    ...
    /**
     * Returns the value of a {@code boolean} field in the given object instance. A class reference
     * is not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a {@code byte} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a {@code char} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a {@code double} field in the given object instance. A class reference
     * is not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a {@code float} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of an {@code int} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a {@code long} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a {@code short} field in the given object instance. A class reference is
     * not sufficient! See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code boolean} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code byte} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code char} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code double} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code float} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code long} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Sets the value of a static {@code short} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Returns the value of a static {@code boolean} field in the given class. See also {@link
     * #findField}.
     */
    ...
    /**
     * Calls an instance or static method of the given object. The method is resolved using {@link
    ...
    /**
     * Calls an instance or static method of the given object. See {@link #callMethod(Object,
     * String, Object...)}.
     *
     * <p>This variant allows you to specify parameter types, which can help in case there are
     * multiple methods with the same name, especially if you call it with {@code null} parameters.
     */
    public static Object callMethod(
            Object obj, String methodName, Class<?>[] parameterTypes, Object... args) {
        try {
            return findMethodBestMatch(obj.getClass(), methodName, parameterTypes, args)
                    .invoke(obj, args);
        } catch (IllegalAccessException e) {
            // should not happen
            XPBridge.log(e);
    ...
    /**
     * Calls a static method of the given class. The method is resolved using {@link
     * #findMethodBestMatch(Class, String, Object...)}.
     *
    ...
    /**
     * Calls a static method of the given class. See {@link #callStaticMethod(Class, String,
     * Object...)}.
     *
     * <p>This variant allows you to specify parameter types, which can help in case there are
     * multiple methods with the same name, especially if you call it with {@code null} parameters.
    ...
    /**
     * Creates a new instance of the given class. The constructor is resolved using {@link
     ...
     *
     * <p>This variant allows you to specify parameter types, which can help in case there are
     * multiple constructors with the same name, especially if you call it with {@code null}
     * parameters.
     */
    ...
    /**
     * Attaches any value to an object instance. This simulates adding an instance field. The value
     * can be retrieved again with {@link #getAdditionalInstanceField}.
     *
     ...
     * @return The previously stored value for this instance/key combination, or {@code null} if
     * there was none.
     */
    ...
    /**
     * Like {@link #setAdditionalInstanceField}, but the value is stored for the class of {@code
     * obj}.
     */
    ...
    /**
     * Like {@link #getAdditionalInstanceField}, but the value is returned for the class of {@code
     * obj}.
     */
    ...
    /**
     * Like {@link #removeAdditionalInstanceField}, but the value is removed and returned for the
     * class of {@code obj}.
     */
    ...
    /**
     * Like {@link #setAdditionalInstanceField}, but the value is removed and returned for {@code
     * clazz}.
     */
     ...
     * to load drawable replacements only once per call, even when multiple {@link
    ...
    /**
     * Decrements the depth counter for the given method. See {@link #incrementMethodDepth} for
     * details.
     *
     * @param method The method name. Should be prefixed with a unique, module-specific string.
     * @return The updated depth.
    ...
    /**
     * Returns the current depth counter for the given method. See {@link #incrementMethodDepth} for
     * details.
     *
     * @param method The method name. Should be prefixed with a unique, module-specific string.
     * @return The updated depth.
     ...
     *
     * <p>So in fact we only need to use the structural comparison results of the reflection object.
     *
     * @see <a
     * href="https://github.com/RinOrz/LSPosed/blob/a44e1f1cdf0c5e5ebfaface828e5907f5425df1b/benchmark/src/result/ReflectionCacheBenchmark.json">benchmarks
     * for ART</a>
     * @see <a
     * href="https://github.com/meowool-catnip/cloak/blob/main/api/src/benchmark/kotlin/com/meowool/cloak/ReflectionObjectAccessTests.kt#L37-L65">benchmarks
     * for JVM</a>
     */
    private abstract static class MemberCacheKey {
        ...
        static final class Method extends MemberCacheKey {
            ...
            public boolean equals(Object o) {
                ...
                return isExact == method.isExact
                        && Objects.equals(clazz, method.clazz)
