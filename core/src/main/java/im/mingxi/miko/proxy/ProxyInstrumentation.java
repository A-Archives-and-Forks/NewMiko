...
public class ProxyInstrumentation extends Instrumentation {
    ...
    public Activity newActivity(ClassLoader cl, String className, Intent intent)
        ...
        try {
            ...
            if (IActivityManagerHandler.isModuleActivity(className)) {
                return (Activity)
                        ActivityProxyManager.ModuleClassLoader.loadClass(className).newInstance();
            }
            throw e;
        }
    }
    ...
    private void inject(Activity activity, Bundle icicle) {
        if (icicle != null) {
            ...
            if (IActivityManagerHandler.isModuleActivity(clzName)) {
                icicle.setClassLoader(ActivityProxyManager.ModuleClassLoader);
            }
        }
    ...
    public void callActivityOnRestoreInstanceState(
            Activity activity, Bundle savedInstanceState, PersistableBundle persistentState) {
    ...
    public void callActivityOnSaveInstanceState(
            Activity activity, Bundle outState, PersistableBundle outPersistentState) {
